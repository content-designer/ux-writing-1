...
Two writers by the fire — one went to training camp. Paste your UI copy, get two blind
rewrites (base **Qwen3.6-27B** vs the **ux-writing-1** QLoRA fine-tune), vote, then see
the reveal. Votes are stored privately as preference data that trains the next version.
